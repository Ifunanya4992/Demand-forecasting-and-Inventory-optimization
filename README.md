...
The dataset used in this project was gotten from Hospital pharmacy inventory containing:
 Drug_Name 
 Category 
 Supplier 
 Transaction_Date 
...
#This project showed me that machine learning can genuinely solve real, costly problems in pharmacy inventory management, prevent expiry risk, stockout thereby improving patient care and preventing financial loss.
